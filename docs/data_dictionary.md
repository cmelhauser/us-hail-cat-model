...
Per-cell severe-hail-day climatology and MESH75 threshold sensitivity on the Stage 05 corrected archive. Regenerated by `scripts/diagnostics/hail_day_climatology.py`. Benchmarks against Cintineo et al. (2012) and Murillo et al. (2021).
