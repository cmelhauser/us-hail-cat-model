...
**Status:** Complete draft — v2.2.2 production hazard results; five-pass GridRad artifact filter with spatiotemporal persistence (2026-07-07); MYRORSS Stage 01 coordinate fix + re-ingest  
